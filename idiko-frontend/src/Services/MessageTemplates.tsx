...
export const idFoundMessage = (
  ...
  const baseMessage = `Good news ${firstName}, your ID is ready for collection. Visit idiko.co.ke under (Find My ID) to confirm, then visit your nearest Huduma Centre for collection. Thank you.`;
...
export function getNotificationMessage(firstName: string): string {
  ...
  return `Good news ${safeName}, your ID is ready for collection. Visit idiko.co.ke under (Find My ID) to confirm, then visit your nearest Huduma Centre for collection. Thank you.`;
}
